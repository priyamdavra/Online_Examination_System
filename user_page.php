...
<link rel="stylesheet" href="CSS/pagination.css" >
	...
	<body>
		...
		<?php 
			...
			<td><a href="enroll.php?exam_id=<?=$rst['id']?>"><img class="change" src="images/signed.png"></a></td>
			
			<td><a href="enroll.php?exam_id=<?=$rst['id']?>"><img class="dlt" src="images/x-button.png"></a></td>
			</tr>
			<?php
			$cnt++;
			}
